        ...
        <div class="carousel-item active">
          ...
          <div class="carousel-caption">
           <p>{{ nouvelleslider.titre }}</p>
              ...
              <div class="nouvelle-left container-fluid" style="padding:30px 15px">
                <div class="row">
                  <div class="col-md-9">
                    <hr>
                    ...
                    <div class="row">
                      <div class="col-md-12 text-left">
                        <div class="ti-tle">{{ image.titre }}</div>
                        <div class="ima-ge">
                          <img :src="'storage/'+image.photo" height="600px" width="100%">
                        </div>
                        <p class="p__create">{{ image.created_at }}</p>
                        <div v-for="images in image.images_multi">
                          <img style="margin-bottom: 20px" :src="'storage/'+images" height="600px" width="100%">
                        </div>
                      </div>
                    </div>
                    </div>
...
<script>
  export default {
    ...
    methods: {
      getimage() {
        axios.get('http://localhost:8000/api/image/' + this.$route.params.slug)
            .then(res => {
...
.nouvelle-left .ti-tle {
    font-size: 40px;
    margin-bottom: 14px;
    font-family: 'Tajawal', sans-serif;
}
.nouvelle-left .ima-ge {
  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
}
.nouvelle-left .p__create {
    font-family: 'Solway', serif;
    font-weight: bold;
    margin-top: 10px;
}
.nouvelle-left .content p {
    font-family: 'Tajawal', sans-serif;
    font-size: 24px;
    padding: 5px 65px;
    color: #0000008c;
